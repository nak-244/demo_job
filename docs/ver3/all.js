...
// FROM: https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js
/*
...
// FROM: https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js
/*!
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/animate-in.js
/**
 * animate-in.js 1.0.0
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/smooth-scroll.js
/**
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/fixed.js
    $(function() {
      var _window = $(window),
        _header = $('.site-header'),
        heroBottom;
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/search.js
    $(function() {
...
// 詳細検索画面
    $(function() {
      var href = "https://sigotora.jp/index.cfm";
      $('#srh_ken_param,#srh_city_param,.srh_shift_param,.srh_span_param,.srh_hour_money_param,#srh_jobtype_param,.srh_jobtype_child_param,.srh_room_type_param,.sfw').on('change', function() {
        var srh_ken_param = $('#srh_ken_param').val();
        var srh_city_param = $('#srh_city_param').val();
        var srh_shift_param = $('.srh_shift_param:checked').map(function() {
                      return $(this).val();
                    }).get();
        var srh_hour_money_param = $('.srh_hour_money_param:checked').map(function() {
                      return $(this).val();
                    }).get();
        var srh_jobtype_param = $('#srh_jobtype_param').val();
        var srh_span_param = $('.srh_span_param:checked').map(function() {
                      return $(this).val();
                    }).get();
        ...
        $('#search').prop('href', href + "?fuseaction=job.joblist" + "&srh_ken_param=" + srh_ken_param + "&srh_city_param=" + srh_city_param + "&srh_shift_param=" + srh_shift_param + "&srh_span_param=" + srh_span_param + "&srh_hour_money_param=" + srh_hour_money_param + "&srh_jobtype_param=" + srh_jobtype_param + "&srh_jobtype_child_param=" + srh_jobtype_child_param + "&srh_room_type_param=" + srh_room_type_param + "&sfw=" + sfw);
      });
    });


// FROM: https://www.olp.co.jp/jobsite_assets/js/load.js
    $(function() {
  	setTimeout(function(){
  		$('.start p').fadeIn(1600);
  	},500);
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/slick.min.js
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/slick_go.js
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/japanmap_start.js
 $(function(){
...
// FROM: https://www.olp.co.jp/jobsite_assets/js/accordion.js
 jQuery(function ($) {
    //コンテンツを非表示に
