...
//            fontColor           : null,
    ...
    Map.prototype.isNanseiIslands = function(path){
        var islands = ["螻倶ｹ?ｳｶ","遞ｮ蟄仙ｳｶ","螂?ｾ手ｫｸ蟲ｶ","豐也ｸ?悽蟲ｶ","螟夊憶髢灘ｳｶ","螳ｮ蜿､蟲ｶ","莨頑弍蜷榊ｳｶ","莨雁ｹｳ螻句ｳｶ","蜈ｫ驥榊ｱｱ隲ｸ蟲ｶ"];
    ...
    Map.prototype.getShortName = function(prefecture_or_area){
        if (this.isArea(prefecture_or_area)){
            return prefecture_or_area.name.replace(/蝨ｰ譁ｹ$/, "");
        }
        return prefecture_or_area.name.replace(/[驛ｽ|蠎忿逵珪$/, "");
    };
    ...
    MapCanvas.prototype.getCenterOfPrefecture = function(prefecture){
        ...
        switch (prefecture.name){
            case "蛹玲ｵｷ驕?"  : OFFSET.X = 10; OFFSET.Y = -5; break;
            case "螳ｮ蝓守恁"  : OFFSET.Y =  5; break;
            case "螻ｱ蠖｢逵?"  : OFFSET.Y = -5; break;
            case "蝓ｼ邇臥恁"  : OFFSET.Y = -3; break;
            case "逾槫･亥ｷ晉恁": OFFSET.Y =  2; break;
            case "蜊?痩逵?"  : OFFSET.X =  7; break;
            case "遏ｳ蟾晉恁"  : OFFSET.Y = -5; break;
            case "貊玖ｳ逵?"  : OFFSET.Y =  5; break;
            case "莠ｬ驛ｽ蠎?"  : OFFSET.Y = -2; break;
            case "蜈ｵ蠎ｫ逵?"  : OFFSET.Y =  4; break;
            case "荳蛾㍾逵?"  : OFFSET.Y = -5; break;
            case "蠎?ｳｶ逵?"  : OFFSET.Y = -3; break;
            case "蟲ｶ譬ｹ逵?"  : OFFSET.X = -5; break;
            case "鬮倡衍逵?"  : OFFSET.X =  5; break;
            case "遖丞ｲ｡逵?"  : OFFSET.Y = -5; break;
            case "髟ｷ蟠守恁"  : OFFSET.Y =  5; break;
        }
